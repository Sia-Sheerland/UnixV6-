...
public:
	...
	*/
	...
	// ------------- NOTE 3: ����ҳĿ¼�����ù���ҳ�� -------------
	static PageDirectory *AllocPageDirectory();
	static void InitProcPageDirectory(Process *proc, PageTable *privateUsrPageTable);
	// ------------- END NOTE 3 -------------

	// ------------- NOTE COW: �޸ĸ�����ҳ���е�RW��ʶ -------------
	static void ModifyPageTable(UserPageManager &userPageManager, PageTable *pgTable);
	// ------------- END NOTE COW -------------
